...
public class ProductController{
	...
	public String handleProductForm(@Valid @ModelAttribute(Constants.PRODUCT_FORM) Product product,BindingResult bindingResult,HttpServletRequest request,Model model) {
		try {
	...
	public ResponseEntity<?> getAllProducts(HttpServletRequest request) {
		...
		String jsonValue = productBO.parseFetchProduct(productRepo.findByMasterId(id));
	...
	public ResponseEntity<?> deleteProduct(@PathVariable(value = "id") int id) {
		...
		try {
			...
			if(null == productService.getProductById(id)) {
