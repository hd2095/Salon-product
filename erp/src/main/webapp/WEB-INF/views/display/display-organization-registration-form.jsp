...
<html lang="en">
	...
	<head><base href="../../../../">
		...
		<link href="assets/css/pages/login/login-3.css?v=7.0.3" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
				...
				<div class="login-content flex-column-fluid d-flex flex-column p-10">
					...
					<div class="d-flex flex-row-fluid flex-center">
						...
						<div class="login-form login-form-signup">
							<!--begin::Form-->
							<form class="form" action = "createOrganization" method="post" novalidate="novalidate" id="kt_login_signup_form">
								<!--begin: Wizard Step 1-->
		...
		<script src="assets/js/pages/custom/login/login-3.js?v=7.0.3"></script>
		<!--end::Page Scripts-->
	</body>
	<!--end::Body-->
</html>