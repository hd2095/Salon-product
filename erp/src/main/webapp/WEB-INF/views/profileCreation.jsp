							...
							<form:form modelAttribute="profileForm" class="form"
								...
								<div class="form-group row">
									<div class="col-lg-6">
										...
										<span class="form-text text-muted">Please enter First
											Name</span>
									</div>
									<div class="col-lg-6">
										...
										<span class="form-text text-muted">Please enter Last
											Name</span>
									</div>
								</div>
								<div class="form-group row">
									...
									<div class="col-lg-6">
										...
										<span class="form-text text-muted">Please enter mobile
											number</span>
									</div>
								</div>
								<div class="form-group row">
								...
								<div class="form-group row passwordField" style="display: none;">
									...
									<div class="col-lg-6">
										<label class="col-form-label">Confirm Password:</label> <input
											type="password" name="confirmPassword" id="confirmPassword" class="form-control" />
										<span class="form-text text-muted">Please Confirm
											password </span>
									</div>
								</div>
