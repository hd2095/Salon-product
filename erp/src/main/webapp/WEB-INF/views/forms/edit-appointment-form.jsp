						...
						<div class="wizard wizard-1" id="new-appointment-wizard"
							...
							<div
								...
								<div class="col-xl-12 col-xxl-7">
									<!--begin::Form Wizard-->
									<form:form modelAttribute="editAppointmentForm" class="form" name="editAppointmentForm"
										action="appointment/edit" method="post"
										...
										<div class="pb-5" data-wizard-type="step-content"
											...
											<div class="row">
												<div class="col-xl-12">
														...
														<div class="col-lg-9 col-xl-9">
															<div class="input-group date">
																<form:input type="text" path="appointmentDate"
																	...
																	readonly="readonly" id="edit_appointment_date" />
													...
													<div class="form-group row">
														<label class="col-xl-3 col-lg-3 col-form-label">Appointment Notes:</label>
														<div class="col-lg-9 col-xl-9">
											...
											<table class="w-100">
												<tr>
													...
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_date"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Appointment
														Time:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_time"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Appointment
														Service:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_service"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Appointment
														Duration:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_duration"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Staff:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_staff"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Appointment
														Cost:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_cost"></td>
												</tr>
												<tr>
													<td class="font-weight-bold text-muted">Appointment
														Notes:</td>
													<td class="font-weight-bold text-right"
														id="edit_selected_appointment_notes"></td>
												</tr>
											</table>
		...
		success: function(response){      
            ...
            for( var i = 0; i<response.data.length; i++){
            	...
            	if(service_id == serviceId){
            		$("#edit_appointment_service").append("<option value='"+service_id+"' selected>"+service_name+"</option>");
            		$('#edit_appointment_cost').val(service_cost);
                	$('#edit_appointment_duration').val(service_duration);
            	}else{
                	$("#edit_appointment_service").append("<option value='"+service_id+"'>"+service_name+"</option>");
                }
               }
		}
	});
		...
		success: function(response){
            ...
            for( var i = 0; i<response.data.length; i++){
            	...
            	if(staff_id == selectedStaffId){
            		$("#edit_appointment_staff").append("<option value='"+staff_id+"' selected>"+staff_name+"</option>");
            	}else{
               	 $("#edit_appointment_staff").append("<option value='"+staff_id+"'>"+staff_name+"</option>");
                }
               }
		}
	});
		...
		success: function(response){      
            for( var i = 0; i<response.data.length; i++){
            	...
            	if(clientId == client_id){
            	 	$("#edit_appointment_client").append("<option value='"+clientId+"' selected>"+clientName+"</option>");
            	 }else{
