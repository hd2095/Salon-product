...
<body id="kt_body"
				...
				<div class="d-flex flex-column-fluid flex-center mt-30 mt-lg-0">
					...
					<div class="login-form login-signup">
						<div class="text-center mb-10 mb-lg-20">
							...
							<p class="text-muted font-weight-bold">Enter organization
								details</p>
						</div>
						<!--begin::Form-->
						<form:form action="register/organization" method="post"
							...
							<div class="form-group">
								<form:input path="organization_name"
									...
									type="text" id="organization_name" placeholder="Organization Name"
							...
							<div class="form-group">
								<form:select path="plan" class="form-control select2"
									id="kt_select2_10" name="plan">
								</form:select>
	...
	<script src="assets/js/pages/custom/register/organization.js"></script>
