...
<head>
<title>OperateIn | Upgrade To Pro Requests</title>
			...
			<div class="card card-custom">
				<div class="card-body">
					<table class="table table-bordered table-hover table-checkable"
						style="margin-top: 13px !important" id="request_dataTable">
						<thead>
							<tr>
...
<script type="text/javascript"
	src="<c:url value="/assets/js/pages/upgradeToProRequests/upgradeToPro.js" />"></script>